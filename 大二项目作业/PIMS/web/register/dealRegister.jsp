<%-- 
    Document   : dealRegister
    Created on : 2018-6-23, 12:30:00
    Author     : xxx_032
--%>
...
<div class="form-info">
				<h2>Signup</h2>
                        ...
                        <%
                                    ...
                                    if(localUser.error.equals("5")){

                        %>    
			<div class="name">
				<label>UserName</label>
				<input class="input1" type="text" name="userName" placeholder="userName is Exist." required="">
			</div>
                        <div class="email">
				<label>Email</label>
			...
			<div class="pass2">
				...
				<input class="input1" type="password" name="confirm_pasdsword" placeholder="**********" required="">
                        ...
                        <%}else if(localUser.error.equals("6")){%>
                        <div class="name">
				<label>UserName</label>
			...
			<div class="pass1">
				<label>Password</label>
				<input class="input1" type="password" name="password" placeholder="both times of password is not same." required="">
			</div>
			<div class="pass2">
				<label>Re-Password</label>
				<input class="input1" type="password" name="confirm_pasdsword" placeholder="both times of password is not same." required="">
			</div>
                        <%}%>
                        <div class="pass3">
				<label>Name</label>
