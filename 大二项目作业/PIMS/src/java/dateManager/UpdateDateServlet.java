...
public class UpdateDateServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if(year.length()==0||month.length()==0||day.length()==0){
            response.sendRedirect("http://localhost:8080/desktop/dateManager/updateDate.jsp");
            ...
            try{
                ...
                rs.beforeFirst();
                if(k<1){
                    response.sendRedirect("http://localhost:8080/PIMS/desktop/dateManager/updateDate.jsp");
                }else{
