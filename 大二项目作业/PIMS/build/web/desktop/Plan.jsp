...
<div id="tooplate_wrapper">
    <div id="tooplate_header_sp">
        <div id="tooplate_menu">
            <ul>
                ...
                <li><a href="http://localhost:8080/PIMS/desktop/Plan.jsp" class="current"><span></span>Plan</a></li>
  ...
  <div id="tooplate_main">
		...
		-->
            <div class="col_fw">
            <h1>Something about your Meetings.</h1>
            <p><em>You can see,delete and add your Meetings here. </em></p>
            </div>
