<%-- 
    Document   : File
    Created on : 2018-6-19, 21:40:26
    Author     : xxx_032
--%>


<%@page import="loginRegister.localUser"%>
<%@page import="fileManager.lookFileServlet"%>
...
<div id="tooplate_wrapper">
  ...
  <div id="tooplate_main">
		...
		-->
            ...
            <p><em>You can see,download,delete and add your project which about yourself here. </em></p>
            </div>
